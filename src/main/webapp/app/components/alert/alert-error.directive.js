(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('springOneGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-springOneGatewayApp-error');
                var entityKey = httpResponse.headers('X-springOneGatewayApp-params');
                if (errorHeader) {
