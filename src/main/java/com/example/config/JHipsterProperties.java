...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SpringOneGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SpringOneGateway API";

        private String description = "SpringOneGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SpringOneGateway";
